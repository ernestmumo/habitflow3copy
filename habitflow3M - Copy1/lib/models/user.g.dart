...
void _userModelSerialize(
  ...
  writer.writeString(offsets[4], object.profileImageUrl);
}
...
UserModel _userModelDeserialize(
  ...
  object.profileImageUrl = reader.readStringOrNull(offsets[4]);
  return object;
}
...
extension UserModelQuerySortBy on QueryBuilder<UserModel, UserModel, QSortBy> {
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> sortByProfileImageUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserModelQuerySortThenBy
  ...
  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByProfileImageUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profileImageUrl', Sort.asc);
    });
  }

  QueryBuilder<UserModel, UserModel, QAfterSortBy> thenByProfileImageUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profileImageUrl', Sort.desc);
    });
  }
...
extension UserModelQueryProperty
  ...
  QueryBuilder<UserModel, String?, QQueryOperations> profileImageUrlProperty() {
    return QueryBuilder.apply(this, (query) {
